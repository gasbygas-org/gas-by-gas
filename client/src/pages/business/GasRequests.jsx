                        ...
                        <div className="backdrop-blur-xl bg-gray-800/30 p-8 rounded-3xl shadow-2xl border border-gray-700/50">
                            ...
                            <div className="space-y-4 overflow-y-auto max-h-[60vh]">
                                {gasRequests.map((request) => {
                                    ...
                                    return (
                                        <div key={request.id} className="flex justify-between p-4 bg-gray-900/20 rounded-xl">
                                            <div className="grid grid-cols-2 gap-4">
                                                <div className="col-span-2">
                                                    <div className="text-lg font-medium">{request.gas_type}</div>
                                                </div>
                                                <div>
                                                    ...
                                                    <div className="text-sm text-gray-300">Token: {request.token}</div>
                                                </div>
                                                <div>
